...
//        var_dump( $page_data['transactions'] ); exit;
    ...
    public function data(){
        ...
        $page_data['transactions'] = $this->site->run_sql("SELECT id, trans_id, amount, description, date_initiated,payment_method, product_id, status FROM transactions WHERE product_id = 1 AND user_id = {$id} ORDER BY id DESC LIMIT 10")->result();
