...
<html lang="en">
<head>
    <title><?= (isset($title)) ? $title : 'Buy Airtime and Data for MTN, Glo, Etisalat, Airtel. Make payment for DSTV, GOTV, PHCN other services'; ?>- Gecharl.com</title>
    <!-- Meta -->
    <meta charset="utf-8">
    ...
    <!-- FontAwesome JS-->
    <script type="text/javascript" src="<?= base_url('assets/plugins/font-awesome/js/fontawesome-all.min.js'); ?>"></script>
    <!-- Global CSS -->
    <link rel="stylesheet" href="<?= base_url('assets/plugins/bootstrap/css/bootstrap.min.css'); ?>">
    <!-- Plugins CSS -->
    <link rel="stylesheet" href="<?= base_url('assets/plugins/pe-icon-7-stroke/css/pe-icon-7-stroke.css'); ?>">
